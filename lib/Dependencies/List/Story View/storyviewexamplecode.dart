...
class storyviewexamplecode extends StatefulWidget {

  @override
  State<storyviewexamplecode> createState() => _storyviewexamplecodeState();
}

class _storyviewexamplecodeState extends State<storyviewexamplecode> {
  String code = """
...
""";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        iconTheme: IconThemeData(color: Colors.white,),
        title: Text("Story View - Code",style: TextStyle(color: Colors.white),),
        backgroundColor: Colors.black,
        centerTitle: true,
        actions: [
          Padding(
